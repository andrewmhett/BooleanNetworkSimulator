...
small_font=pygame.font.SysFont("Arial",60)
...
pygame.gfxdraw.box(button_up_surf,pygame.Rect(0,0,2*comp_width,2*comp_height),(255,255,255))
pygame.gfxdraw.box(button_down_surf,pygame.Rect(0,0,2*comp_width,2*comp_height),(255,255,255))
...
class ConnectionPoint:
    ...
    def draw(self):
       ...
       pygame.draw.circle(screen,color,center,int(0.5+(self.parent_obj.height/(12*scale_factor))))
       pygame.gfxdraw.aacircle(screen,center[0],center[1],int(self.parent_obj.height/(12*scale_factor)),(0,0,0))
    def dump(self):
        return {
            ...
            if event.type==pygame.MOUSEBUTTONUP:
                if pygame.mouse.get_pressed(0):
                    if not moved:
                        if get_component_collision(event.pos[0],event.pos[1]) != None:
                            component=get_component_collision(event.pos[0],event.pos[1])
                            if not pygame.key.get_pressed()[304]:
